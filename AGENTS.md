...
> Instructions for OpenAI Codex and other AI coding agents working on this repository.

**Random-Timer** — A software project.

## Project Rules

All project rules are maintained in `.ai/rules/`. Read all files in that directory before making changes (tech stack, architecture, coding conventions, TypeScript, React, styling, naming, git workflow, testing, forbidden patterns, AI agent instructions).
