...
Source: `python3 scripts/asc/asc_verify_ready.py --version 1.2.1 --skip-build-check --json .artifacts/asc_verify_ready_20260226.json`
...
- `python3 scripts/asc/asc_verify_ready.py --version 1.2.1 --skip-build-check --json .artifacts/asc_verify_ready_20260226.json`
