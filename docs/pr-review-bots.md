...
| **Seer (Sentry)** | Safety / error-handling review comments | Not a required status check; unresolved Sentry threads are enforced by `Autonomous AI Review` | `.github/seer.app.yml`, `Autonomous AI Review` |
...
- `develop` and release branches require the core CI gates plus Claude, Sonar, and platform build/test checks before merge.
