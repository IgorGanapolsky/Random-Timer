...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--lookback-days", type=int, default=_to_int(os.getenv("SENTRY_INCIDENT_LOOKBACK_DAYS"), DEFAULT_LOOKBACK_DAYS))
    parser.add_argument("--min-events", type=int, default=_to_int(os.getenv("SENTRY_INCIDENT_MIN_EVENTS"), DEFAULT_MIN_EVENTS))
    parser.add_argument("--min-users", type=int, default=_to_int(os.getenv("SENTRY_INCIDENT_MIN_USERS"), DEFAULT_MIN_USERS))
    parser.add_argument("--max-issues", type=int, default=_to_int(os.getenv("SENTRY_INCIDENT_MAX_ISSUES"), DEFAULT_MAX_ISSUES))
