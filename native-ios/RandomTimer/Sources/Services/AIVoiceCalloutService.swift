...
private enum VoicePreviewSampleCatalog {
    ...
    static let femaleCommandFilenames = [
        "female/cmd_breathe_recover_press",
        "female/cmd_do_not_coast",
        "female/cmd_drive_forward",
        "female/cmd_drive_through_it",
        "female/cmd_eyes_up_keep_moving",
        "female/cmd_finish_rep_keep_pushing",
        "female/cmd_instant_response_go",
        "female/cmd_keep_pressure",
        "female/cmd_keep_pressure_on",
        "female/cmd_keep_tempo_high",
        "female/cmd_keep_your_bearing",
        "female/cmd_maintain_your_interval",
        "female/cmd_most_ricky_tick",
        "female/cmd_move_fast_stay_precise",
        "female/cmd_move_now",
        ...
        "female/cmd_push_through",
        "female/cmd_reset_and_attack",
        "female/cmd_reset_breathe",
