...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/.gsd-surface.json`
(sibling to `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/skills/gsd-*/`.
...
(`/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor`), NOT the skills sub-directory (`/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor` as `configDir`. The skill dirs themselves live at
`/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor}"
SCOPE="global"
...
(i.e. `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/.gsd-surface.json`
Install profile marker: `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/.gsd-profile`
Skill dirs: `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/skills/gsd-*/`
Engine module: `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/igorganapolsky/workspace/git/igor/Random-Timer/.claude/worktrees/opengsd-gsd-core/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
